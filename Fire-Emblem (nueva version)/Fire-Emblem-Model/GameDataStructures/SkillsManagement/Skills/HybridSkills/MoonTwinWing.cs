...
public class MoonTwinWing : Skill
{
    public MoonTwinWing() : base()
    {
        ...
        this.Conditions[0] = new OwnHpBiggerThanCondition(0.25);
        this.Conditions[1] = new OwnHpBiggerThanCondition(0.25);
        this.Conditions[2] = new AndCondition([new CompareTotalSpd(), new OwnHpBiggerThanCondition(0.25)]);
