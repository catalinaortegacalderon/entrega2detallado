...
public class ChangeOpponentsStatsInBaseStatDifferencePercentajeEffect: Effect
{
    private readonly double _percentage;
    private readonly StatType _stat;
    private readonly StatType _referenceStat;

    public ChangeOpponentsStatsInBaseStatDifferencePercentajeEffect(StatType stat, double percentage, 
