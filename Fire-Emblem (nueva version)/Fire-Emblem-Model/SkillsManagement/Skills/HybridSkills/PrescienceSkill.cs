...
{
    public PrescienceSkill() : base()
    {
        this.Conditions = new Condition[3];
        this.Conditions[0] = new AlwaysTrueCondition();
        this.Conditions[1] = new AlwaysTrueCondition();
        this.Conditions[2] = new OrCondition([new MyUnitStartsCombatCondition(), new OpponentUsesCertainWeaponCondition([Weapon.Magic, Weapon.Bow])]);
